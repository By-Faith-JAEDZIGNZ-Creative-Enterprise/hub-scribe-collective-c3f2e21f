...
const SAMPLE_PROJECT_URL = "https://hub-scribe-collective.lovable.app"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  // Send directly via the Resend connector gateway (same path the newsletter uses).
  ...
  if (!sendRes.ok) {
    ...
    console.error('Failed to send auth email', { status: sendRes.status, body, run_id, emailType })
